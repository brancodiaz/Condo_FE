...
@Component({
  ...
  template: `
    <div class="navbar bg-base-100 shadow-sm px-4">
      <div class="flex-1">
        <span class="text-xl font-bold">Condo App</span>
      </div>
      <div class="flex-none gap-2 items-center">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-10 w-52 p-2 shadow">
            <li><a class="text-base-content/60 cursor-not-allowed">Perfil</a></li>
            <li><a (click)="authService.logout()">Cerrar Sesion</a></li>
          </ul>
        </div>
      </div>
    </div>
...
export class TopBarComponent {
  ...
  readonly userName = () => this.authService.currentUser()?.fullName ?? '';
}
